<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"D:\xampp\tongji-master\public/../application/admin\view\declared\declaredsyr\edit.html";i:1629986105;s:65:"D:\xampp\tongji-master\application\admin\view\layout\default.html";i:1574934466;s:62:"D:\xampp\tongji-master\application\admin\view\common\meta.html";i:1574934466;s:64:"D:\xampp\tongji-master\application\admin\view\common\script.html";i:1574934466;}*/ ?>
<!DOCTYPE html>
...
<input type="hidden" value="<?php echo $ids; ?>" id="edit_id">
    ...
    <input type="hidden" id="declareds_time" value="<?php echo $v['mon']; ?>">
        ...
        <?php if($v['pid'] == '0'): ?>
            <div class="form-group">
        <label for="name" class="control-label col-xs-12 col-sm-3"  title="<?php echo $v['rf_note']; ?>" ><b><?php echo $v['name']; ?></b></label>
		...
		<?php elseif($v['pid'] == ''): else: ?>
         ...
         ?>
        <label for="name" class="control-label col-xs-12 col-sm-3"  title="<?php echo $v['rf_note']; ?>" ><?php 
        	if($num==0)
       	{
       		echo $v['name'];
       	}
        ...
        <label for="name" class="control-label col-xs-12 col-sm-1 lastyear_s" id="lastyear_<?php echo $v['rf_id']; ?>"></label>
        <label for="name" class="control-label col-xs-12 col-sm-1" id="growth_<?php echo $v['rf_id']; ?>"></label>
          </div>
        <?php endif; ?>
