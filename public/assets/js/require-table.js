        ...
        api: {
            ...
            bindevent: function (table) {
                ...
                $(toolbar).on('click', Table.config.addbtn, function () {
                    ...
                    if(url=="declared/declaredm/add")
                    {
                    	Fast.api.open(url,"月报表", $(this).data() || {});
                    }
                    else if(url=="declared/declareds/add")
                    {
                    	Fast.api.open(url,"季报表", $(this).data() || {});
                    }
                    else if(url=="declared/declaredy/add")
                    {
                    	Fast.api.open(url,"年报表", $(this).data() || {});
                    }
                    else
                    {
                    	Fast.api.open(url, __('Add'), $(this).data() || {});
