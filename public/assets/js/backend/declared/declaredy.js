    ...
    var Controller = {
        index: function () {
                    ...
                    [
                        ...
                        {field: 'operate', title: __('Operate'), table: table, events: Table.api.events.operate,
                            buttons: [{
                                ...
                                url: 'declared/declaredy/uploadlist'
                                ...
                                url: 'declared/declaredy/print_excel'
         ...
         uploadlist: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'declared/declaredy/uploadlist?fa_id='+$('#fa_id').val(),
                    del_url: 'declared/declaredy/filedel',
                }
            });
        ...
        add: function () {
		  ...
		  $.ajax({url:"declared/declaredy/getdata",success:function(result){
        	...
        	$.ajax({url:"declared/declaredy/getlastyeardata?mon="+$('#declareds_time').val()+"&company_id="+$('#company_select').val(),success:function(result){
        ...
        edit: function () {
        		...
        		$.ajax({url:"declared/declaredy/getlastyeardata?mon="+$('#declareds_time').val()+"&company_id=&id="+$('#edit_id').val(),success:function(result){
			  		if(result=="")
			        	{
			        		$('.lastyear_s').html("");	
			        	}
