define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'mon', title: '报表季度',operate: false,sortable: true},
                        ...
                        {field: 'operate', title: __('Operate'), table: table, events: Table.api.events.operate,
                             buttons: [{
                                ...
                                url: 'declared/declareds/uploadlist'
        ...
        uploadlist: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'declared/declareds/uploadlist?fa_id='+$('#fa_id').val(),
                    del_url: 'declared/declareds/filedel',
                }
            });
        ...
        add: function () {
        		...
        		$('#set_time').val(declareds_time);
        		validity_time=$('#validity_year').val()+"-"+$('#validity_mon').val();
        		$('#validity_time').val(validity_time);

        		 $.ajax({url:"declared/declareds/getdata",success:function(result){
        		...
        		$.ajax({url:"declared/declareds/getlastyeardata?mon="+$('#set_time').val()+"&company_id="+$('#company_select').val(),success:function(result){
			  		if(result=="")
			        	{
			        		$('.lastyear_s').html("");	
			        	}
        ...
        edit: function () {
		  ...
		  $.ajax({url:"declared/declareds/getdata",success:function(result){
        	  ...
        	  $.ajax({url:"declared/declareds/getlastyeardata?mon="+$('#declareds_time').val()+"&company_id=&id="+$('#edit_id').val(),success:function(result){
			  		if(result=="")
			        	{
			        		$('.lastyear_s').html("");	
			        	}
