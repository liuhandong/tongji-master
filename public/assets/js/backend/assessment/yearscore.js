define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'assessment/yearscore/index',
                    //edit_url: 'assessment/yearscore/edit'
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'mon', title: '报表年份',operate: 'LIKE',sortable: true},
                        ...
                        {field: 'operate', title: __('Operate'), table: table, events: Table.api.events.operate,
                            buttons: [
							{
                                ...
                                icon: 'fa fa-file',
                                classname: 'btn btn-xs btn-warning',
                                url: 'assessment/yearscore/print_excel'
