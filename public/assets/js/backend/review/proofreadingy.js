define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    ...
                    edit_url: 'review/proofreadingy/edit',
                }
            });
                    ...
                    [
                        ...
                        {field: 'is_key_name', title: '状态', operate: false},
                        {
                            ...
                            buttons: [{
                                ...
                                url: 'review/proofreadingy/backward',
                                confirm: '确认驳回?',
        ...
        edit: function () {
        	  $.ajax({url:"review/proofreadingy/getdata",success:function(result){
