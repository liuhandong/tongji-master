        ...
        index: function () {
            ...
            Table.api.init({
                extend: {
                    ...
                    //edit_url: 'review/proofreadingm/edit'
                    ...
                    [
                        ...
                        {field: 'is_key_name', title: '状态', operate: false},
                        {
                            ...
                            buttons: [
                                ...
                                url: 'review/proofreadingm/backward',
                                confirm: '确认驳回?',
				     	...
				     	$("#check_"+val.id).blur(function(){
				     		if($("#check_"+val.id).val()!=0)
				     		{
			     				...
			     				$('#growth_'+val.id).html(growth);
						  		...
						  		$.ajax({url:"review/proofreadingm/gettotaldata?rf_id="+val.id+"&id="+$('#edit_id').val(),success:function(result){
						  			//alert(result);
							  		if(result=="")
							        	{
							        		$('#total_'+val.id).html($("#check_"+val.id).val());	
							        	}
							        	else
							        	{
							        		//total=Number($("#check_"+val.id).val())+Number(result);
							        		total=Number($("#check_"+val.id).val()).add(Number(result));
